...
with open("sleep apnea/utils/additional-information.txt", "r") as f:
    original = []
    for line in f:
...
np.savetxt(os.path.join(base_dir, "table_RFANet.csv"), result, fmt="%s", delimiter=",", comments="",
